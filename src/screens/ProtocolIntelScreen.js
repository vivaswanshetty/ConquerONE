...
function ForearmsTab() {
    return (
        <View style={styles.tabContent}>
            ...
            <View style={[styles.premiumCard, { borderColor: COLORS.border }]}>
                <LinearGradient
                    colors={["rgba(255,255,255,0.03)", "transparent"]}
                    style={StyleSheet.absoluteFill}
                />
                <View style={styles.cardHeader}>
                    <View style={[styles.accentBadge, { backgroundColor: "rgba(255,255,255,0.05)", borderColor: COLORS.border }]}>
                        <Ionicons name="barbell-outline" size={14} color={COLORS.textSub} />
                    </View>
                    <Text style={[styles.cardTitle, { color: COLORS.text }]}>THE HONEST TRUTH</Text>
                </View>
        ...
        <View style={styles.tabContent}>
            ...
            {PLAN_RULES.map((item, idx) => (
                <View key={idx} style={styles.premiumCard}>
                    ...
                    <View style={styles.cardHeader}>
                        <View style={[styles.accentBadge, { backgroundColor: "rgba(255,255,255,0.05)", borderColor: COLORS.border }]}>
                            <Ionicons name={ICONS[idx] || "checkmark"} size={14} color={COLORS.textSub} />
                        </View>
...
function TimelineTab() {
    return (
        <View style={styles.tabContent}>
            ...
            {/* The Only Secret */}
            <View style={[styles.premiumCard, { borderColor: COLORS.border, borderWidth: 1, marginTop: 24, backgroundColor: "rgba(255,255,255,0.02)" }]}>
                <View style={styles.cardHeader}>
                    <View style={[styles.accentBadge, { backgroundColor: "rgba(255,255,255,0.05)", borderColor: COLORS.border }]}>
                        <Ionicons name="key" size={14} color={COLORS.textSub} />
                    </View>
                    <Text style={[styles.cardTitle, { color: COLORS.text }]}>{PLAN_SECRET.title}</Text>
                </View>
